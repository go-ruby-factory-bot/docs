# go-ruby-factory-bot documentation

**Pure-Go factory_bot: test-data factories (build/create/traits/sequences/associations), CGO=0 — bound into rbgo**

`go-ruby-factory-bot/factory-bot` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `factory-bot`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-factory-bot/factory-bot`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `factory-bot`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`factory-bot`](https://github.com/go-ruby-factory-bot/factory-bot) | the library — Ruby's `factory-bot` in pure Go |
| [`docs`](https://github.com/go-ruby-factory-bot/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-factory-bot.github.io`](https://github.com/go-ruby-factory-bot/go-ruby-factory-bot.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-factory-bot/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-factory-bot/factory-bot](https://github.com/go-ruby-factory-bot/factory-bot).
