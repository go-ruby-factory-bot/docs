...
Contributions are welcome. `go-ruby-factory-bot/factory-bot` is built to a small set of
...
The library is in [`github.com/go-ruby-factory-bot/factory-bot`](https://github.com/go-ruby-factory-bot/factory-bot).
This documentation site is in [`github.com/go-ruby-factory-bot/docs`](https://github.com/go-ruby-factory-bot/docs).
