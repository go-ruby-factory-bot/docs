...
The public API lives at the module root (`github.com/go-ruby-factory-bot/factory-bot`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `factory-bot`, while the surface follows
...
```go
import "github.com/go-ruby-factory-bot/factory-bot"
```
...
- **[pkg.go.dev/github.com/go-ruby-factory-bot/factory-bot](https://pkg.go.dev/github.com/go-ruby-factory-bot/factory-bot)**

The module's [README](https://github.com/go-ruby-factory-bot/factory-bot#readme) carries worked
